...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/turtlebot_apps/turtlebot_calibration)
  set(turtlebot_calibration_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'OSRF <turtlebot@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/turtlebot_apps/turtlebot_calibration/${idir}'.  Ask the maintainer 'OSRF <turtlebot@osrfoundation.org>' to fix it.")
    endif()
...
set(turtlebot_calibration_EXPORTED_TARGETS "turtlebot_calibration_generate_messages_cpp;turtlebot_calibration_generate_messages_lisp;turtlebot_calibration_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${turtlebot_calibration_dep}_FOUND)
      find_package(${turtlebot_calibration_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtlebot_calibration_dep} REQUIRED ${depend_list})
  endif()
